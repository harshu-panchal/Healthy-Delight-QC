...
router.patch("/orders/batch-assign-delivery", orderController.batchAssignDeliveryBoy);
...
router.post("/customers/:id/wallet/credit", customerController.creditCustomerWallet);
