...
export default function SellerOrderDetail() {
  ...
  const handleExportPDF = () => {
    ...
    doc.setFontSize(12);
    doc.setFont("helvetica", "bold");
    doc.text("Healthy Delight", margin, yPos);
    yPos += 7;
    ...
    doc.text("Bill Generated by Healthy Delight", pageWidth / 2, yPos, {
      align: "center",
    });
    yPos += 8;
    ...
    <div className="min-h-screen bg-neutral-50 pb-8">
      ...
      <div id="printable-invoice" className="bg-white rounded-lg shadow-sm border border-neutral-200 overflow-hidden">
        ...
        <div className="bg-white px-4 sm:px-6 py-6">
          {orderDetail.orderType === "Scheduled" && (
            <div className="mb-6 p-4 rounded-xl bg-blue-50 border border-blue-200 flex items-center gap-3">
              ...
              <div>
                <span className="text-xs font-black text-blue-700 uppercase tracking-wider block">Scheduled Delivery Order</span>
                <span className="text-sm font-bold text-neutral-800">
                  Deliver on {formatDate(orderDetail.deliveryDate)} ({orderDetail.timeSlot})
                </span>
              </div>
            </div>
          )}
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-6 mb-6">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-neutral-600 mb-1">
                <span className="font-medium">From:</span> Healthy Delight
              </div>
          ...
          <div className="mt-6 flex justify-end">
            <div className="w-full sm:w-96 bg-neutral-50 rounded-xl p-5 border border-neutral-200 shadow-sm space-y-4">
          ...
          <div className="border-t border-dashed border-neutral-300 pt-6 mt-6">
            <p className="text-sm text-neutral-600 text-center">
              Bill Generated by Healthy Delight
            </p>
          </div>
        </div>
      </div>
