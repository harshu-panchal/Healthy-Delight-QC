                        ...
                        <div className="flex flex-col sm:flex-row gap-3 flex-1">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <select
                                    ...
                                    className="px-3 py-2 bg-white border border-neutral-300 rounded text-sm focus:ring-1 focus:ring-primary focus:outline-none cursor-pointer"
                                >
                                        ...
                                        <tr key={index} className="hover:bg-neutral-50">
                                            ...
                                            <td className="p-4 border border-neutral-200 text-sm text-neutral-900">
                                                <button
                                                    ...
                                                    className="text-primary-dark hover:text-primary-dark text-xs font-medium transition-colors"
                                                >
                                                    View
                                                </button>
                                            </td>
                    ...
                    <div className="p-4 border-t border-neutral-100 flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="w-8 h-8 flex items-center justify-center border border-primary/50 rounded hover:bg-cream disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                            >
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
