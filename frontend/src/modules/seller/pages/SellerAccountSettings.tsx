              ...
              {tabs.map((tab) => (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 ${activeTab === tab.id
                    ? 'bg-cream text-primary-dark shadow-sm ring-1 ring-primary-200'
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-6 pb-8 border-b border-gray-100">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              <span className="px-2.5 py-0.5 rounded-full text-xs font-bold bg-cream text-primary-dark uppercase tracking-wide">
                          ...
                          <div className="space-y-1.5">
                            ...
                            <div className="relative">
                              <select
                                ...
                                disabled={!isEditing}
                                className="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none disabled:bg-gray-50/50 disabled:text-gray-500 transition-all appearance-none bg-white"
                              >
