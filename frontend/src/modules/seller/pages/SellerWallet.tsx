  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <motion.div
        ...
        className="m-4 bg-gradient-to-r from-cream to-primary rounded-2xl p-6 text-neutral-900 shadow-lg border border-primary/30"
      >
              ...
              {(() => {
                ...
                return allItems.map((item: any) => (
                  <div key={item._id} className="flex justify-between items-start p-3 bg-gray-50 rounded-lg">
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {item.status === 'Completed' && (
                          <span className="bg-cream text-neutral-900 text-xs px-2 py-0.5 rounded-full font-medium border border-primary/40">
                            Success
                          </span>
                        )}
                      </div>
                    ...
                    <p className={`font-bold text-lg ${item.type === 'Credit' ? 'text-neutral-900' : 'text-red-600'} ${item.status === 'Pending' ? 'opacity-60' : ''}`}>
                    ...
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-semibold ${withdrawal.status === 'Completed'
                          ? 'bg-cream text-neutral-900 border border-primary/40'
