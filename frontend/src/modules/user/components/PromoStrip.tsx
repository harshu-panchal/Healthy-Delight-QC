              ...
              return (
                <div key={card.id} className="promo-card">
                  <Link
                    ...
                    {/* Light Brown Discount Banner - Only around text, centered at top */}
                    <div
                      className="w-full flex justify-center"
                      style={{ paddingTop: "0", paddingBottom: "2px" }}>
                      <div className="bg-[#E6D5C3] text-[#8A6642] text-[9px] font-black px-1.5 py-0.5 rounded tracking-tight text-center inline-block border border-[#8A6642]/20 shadow-sm">
                        {card.badge}
                      </div>
                    </div>
