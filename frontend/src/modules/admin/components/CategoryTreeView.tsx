        ...
        return (
          <div key={category._id} className="relative">
            ...
            <div
              className={`${
                isSubcategory
                  ? "bg-cream border-l-4 border-l-primary border border-primary/30 rounded-r-lg p-3"
                  : "bg-white border border-neutral-200 rounded-lg p-4"
              } hover:shadow-md transition-all ${
                isSubcategory ? "hover:bg-primary/20" : ""
              }`}
                  ...
                  {category.image ? (
                    ...
                    <div
                      className={`${
                        ...
                        isSubcategory ? "bg-primary/20" : "bg-neutral-100"
                      } flex items-center justify-center`}>
                      <span
                        className={`${
                          isSubcategory ? "text-lg" : "text-2xl"
                        } font-semibold ${
                          isSubcategory ? "text-neutral-900" : "text-neutral-400"
                        }`}>
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <button
                        ...
                        className="bg-white border-2 border-primary text-primary hover:bg-primary hover:text-white px-3 py-1.5 rounded text-xs font-medium flex items-center gap-1.5 transition-all active:scale-95 shadow-sm"
                        ...
                        <span className={isSubcategory ? "hidden sm:inline" : ""}>
                          Add Subcategory
                        </span>
                      </button>
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 text-xs font-medium border-2 rounded transition-all active:scale-95 shadow-sm ${
                          category.status === "Active"
                      ...
                      <button
                        ...
                        className="p-1.5 bg-white border-2 border-neutral-800 text-neutral-800 hover:bg-neutral-800 hover:text-white rounded transition-all active:scale-95 shadow-sm"
                        title="Edit">
                        <svg
                          width="16"
                          height="16"
                      ...
                      <button
                        ...
                        className="p-1.5 bg-white border-2 border-red-600 text-red-600 hover:bg-red-600 hover:text-white rounded transition-all active:scale-95 shadow-sm"
                        title="Delete">
                        <svg
                          width="16"
                          height="16"
