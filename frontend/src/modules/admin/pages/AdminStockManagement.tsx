            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-neutral-300 rounded text-sm focus:ring-1 focus:ring-primary focus:outline-none cursor-pointer">
                ...
                {loading ? (
                  ...
                  displayedProducts.map((product) => (
                    <tr
                      ...
                      <td className="p-4 align-middle">
                        {product.stock === "Unlimited" ? (
                          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-cream text-neutral-800">
                            Unlimited
                          </span>
                        ) : (
