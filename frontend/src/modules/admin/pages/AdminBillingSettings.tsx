        ...
        >
            <div className="flex justify-between items-center mb-6">
                ...
                <button
                    onClick={handleSave}
                    disabled={saving}
                    className="px-6 py-2.5 bg-neutral-900 text-white rounded-lg font-medium hover:bg-neutral-800 transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    {saving ? (
                        <>
            ...
            <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
                    <div className="flex justify-between items-start mb-6 pb-2 border-b">
                        ...
                        <div className="flex items-center gap-2 bg-neutral-100 p-1 rounded-lg">
                            ...
                            <button
                                ...
                                className={`px-3 py-1.5 text-sm font-medium rounded-md transition-all ${isDistanceBased ? 'bg-white text-neutral-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'
                                    }`}
                            >
                                Distance Based
                            </button>
                    ...
                    {!isDistanceBased ? (
                        ...
                        >
                            <div className="col-span-full bg-cream border border-primary/30 rounded-lg p-3 text-sm text-neutral-800 mb-2">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full pl-4 pr-10 py-2 border border-gray-300 rounded-lg focus:ring-primary focus:border-primary"
                                    />
