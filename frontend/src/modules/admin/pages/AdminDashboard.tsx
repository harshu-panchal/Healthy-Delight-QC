    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-neutral-200 overflow-hidden">
        <div className="bg-[#0a193b]/5 px-4 sm:px-6 py-3 flex justify-between items-center border-b border-neutral-200">
          <h2 className="text-base sm:text-lg font-bold text-[#0a193b]">Wholesale B2B Performance (Admin View)</h2>
          <span className="text-xs font-semibold bg-[#0a193b]/10 text-[#0a193b] px-2 py-0.5 rounded-full">Admin Control</span>
        </div>
        <div className="p-4 sm:p-6 grid grid-cols-2 md:grid-cols-3 gap-4">
          <div className="bg-neutral-50 p-4 rounded-xl border border-neutral-100 flex flex-col justify-center">
            <span className="text-xs font-semibold text-neutral-500 uppercase tracking-wider mb-1">Total Wholesale Orders</span>
            <span className="text-xl sm:text-2xl font-extrabold text-neutral-900">{(stats as any).wholesaleOrders || 0}</span>
          </div>
          <div className="bg-neutral-50 p-4 rounded-xl border border-neutral-100 flex flex-col justify-center">
            <span className="text-xs font-semibold text-neutral-500 uppercase tracking-wider mb-1">Total Wholesale Revenue</span>
            <span className="text-xl sm:text-2xl font-extrabold text-emerald-600">₹{((stats as any).wholesaleRevenue || 0).toFixed(2)}</span>
          </div>
          <div className="bg-neutral-50 p-4 rounded-xl border border-neutral-100 flex flex-col justify-center">
            <span className="text-xs font-semibold text-neutral-500 uppercase tracking-wider mb-1">Low Stock Wholesale Products</span>
            <span className={`text-xl sm:text-2xl font-extrabold ${((stats as any).lowWholesaleStockProducts || 0) > 0 ? 'text-amber-600' : 'text-neutral-900'}`}>
              {(stats as any).lowWholesaleStockProducts || 0}
            </span>
          </div>
        </div>
      </div>
