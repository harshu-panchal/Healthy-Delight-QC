...
export default function AdminDeliveryAppPolicy() {
  const [policyContent, setPolicyContent] = useState(`Welcome to Healthy Delight - 10 Minute App Delivery Partner Program!
        ...
        <div className="max-w-4xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end gap-4">
              ...
              <button
                type="submit"
                className="bg-primary border-primary text-neutral-900 hover:bg-neutral-900 text-white px-8 py-2.5 rounded-lg text-base font-medium transition-colors"
              >
                Update Policy
              </button>
            </div>
